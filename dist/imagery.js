iD.data.imagery = [
    ...
    },
    {
        ...
        "template": "http://services.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{zoom}/{y}/{x}",
        "type": "tms"
    },
    {
        "default": true,
        ...
        "template": "http://{switch:a,b,c}.tiles.mapbox.com/v3/nps.map-n9nxe12m/{zoom}/{x}/{y}.png",
    ...
    },
    {
        ...
        "template": "http://navigator.er.usgs.gov/tiles/tilecache.cgi/1.0.0/naip/{zoom}/{x}/{y}.jpg",
        "type": "tms",
        "polygon": [
            [
                [
    ...
    },
    {
        ...
        "template": "http://45.55.178.97:3003/tileLode/esriOverlay/{zoom}/{y}/{x}.png",
        "type": "tms"
    }, 
    {
        "default": true,

...
window.onload = function() {
  ...
  document.getElementById('switch-to-viewer').style.display = (mode === 'edit' ? 'block': 'none');
  document.getElementById('switch-to-editor').style.display = (mode === 'edit' ? 'none': 'block');
  iframe.src = src;
